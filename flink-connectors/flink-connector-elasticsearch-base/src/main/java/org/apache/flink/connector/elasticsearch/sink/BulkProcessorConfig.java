...
public class BulkProcessorConfig implements Serializable {
    ...
    private final BulkRequestConsumerFactory bulkRequestConsumer;

    public BulkProcessorConfig(
            ...
            BulkRequestConsumerFactory bulkRequestConsumer) {
        ...
        this.bulkRequestConsumer = bulkRequestConsumer;
    }
