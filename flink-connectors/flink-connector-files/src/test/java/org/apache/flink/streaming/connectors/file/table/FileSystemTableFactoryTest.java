...
import org.apache.flink.connector.file.src.FileSystemTableFactory;
import org.apache.flink.connector.file.src.FileSystemTableSink;
import org.apache.flink.connector.file.src.FileSystemTableSource;
...
import static org.apache.flink.connector.file.src.FileSystemConnectorOptions.SINK_PARTITION_COMMIT_WATERMARK_TIME_ZONE;
...
public class FileSystemTableFactoryTest {
    ...
    public void testSourceSink() {
        ...
        DynamicTableSource source = FactoryMocks.createTableSource(SCHEMA, descriptor.asMap());
        assertTrue(source instanceof FileSystemTableSource);

        DynamicTableSink sink = FactoryMocks.createTableSink(SCHEMA, descriptor.asMap());
    ...
    public void testLackOptionSource() {
        ...
        try {
            FactoryMocks.createTableSource(SCHEMA, descriptor.asMap());
    ...
    public void testLackOptionSink() {
        ...
        try {
            FactoryMocks.createTableSink(SCHEMA, descriptor.asMap());
        } catch (ValidationException e) {
            Throwable cause = e.getCause();
            assertTrue(cause.toString(), cause instanceof ValidationException);
            assertTrue(
