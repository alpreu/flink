...
import org.apache.flink.streaming.connectors.file.table.AbstractFileSystemTable;
import org.apache.flink.streaming.connectors.file.table.SerializationSchemaAdapter;
...
public class FileSystemTableSink extends AbstractFileSystemTable
    ...
    //                                CompactOperator.convertToUncompacted(randomPrefix))
    ...
    //                                    path,
    //                                    new ProjectionEncoder((Encoder<RowData>) writer,
    // computer))
    ...
    //                                    () ->
    //                                            new TableException(
    //                                                    "Please implement available reader for
    // compaction:"
    //                                                            + " BulkFormat,
    // FileInputFormat."));
    //
    ...
    //    }
    //
    //    private Optional<CompactReader.Factory<RowData>> createCompactReaderFactory(Context
    // context) {
    ...
    //                            decoder, schema,
    // context.createTypeInformation(schema.toPhysicalRowDataType()), projectedFields,
    ...
    //                : path -> createBulkWriterOutputFormat((BulkWriter.Factory<RowData>) writer,
    // path);
    //    }
