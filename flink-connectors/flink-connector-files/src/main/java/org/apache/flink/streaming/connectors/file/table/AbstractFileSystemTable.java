...
import static org.apache.flink.streaming.connectors.file.table.FileConnectorOptions.PARTITION_DEFAULT_NAME;
import static org.apache.flink.streaming.connectors.file.table.FileConnectorOptions.PATH;
...
public abstract class AbstractFileSystemTable {
    ...
    protected AbstractFileSystemTable(DynamicTableFactory.Context context) {
    ...
    protected DataType getFormatDataType() {
